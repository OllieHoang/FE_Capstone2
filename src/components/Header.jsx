...
import { AiOutlinePlus, AiOutlineQuestionCircle, AiFillCaretDown } from 'react-icons/ai';
...
const Header = (props) => {
    ...
    return (
        ...
        <div
            className={`${
                isAction2 ? 'bg-white py-2 lg:px-24 shadow-md' : 'bg-none py-2 shadow-md lg:px-24  '
            }  z-20 w-full fixed`}
        >
