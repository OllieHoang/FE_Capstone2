    ...
    return (
        <div>
            <div
                className={`${
                    isActive
                        ? 'border rounded-md mt-10 flex px-4 py-2 gap-x-8 h-[150px] shadow-sm '
                        : 'border rounded-md mt-10 flex px-4 py-2 gap-x-8 h-[150px] opacity-50'
                }`}
            >
                                ...
                                <div className="flex items-center">
                                    ...
                                    <span className="ml-1 hidden sm:block">
                                        <div
                                            ...
                                            className="sc-iGctRS sc-irlOZD gOVmho jUdyne"
                                        ></div>
                                    </span>
                                </div>
                            </button>
