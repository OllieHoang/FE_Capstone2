...
const Profile = () => {
    ...
    return (
        <section className="">
            ...
            <div className="h-screen mt-6 mx-auto w-[60%] justify-around">
                <h2 className="text-2xl flex  justify-center mb-8">My account</h2>
                <div className="flex gap-x-24 basis-1/2">
                    <div>
                        <img
                            src={avatar}
                            alt=""
                            className="w-[230px] h-[230px] rounded-full object-cover border-[#BDC3C7] border-2 p-1"
                        />
                        <div className="flex justify-center mt-4 text-blue-600 font-medium items-center gap-x-2">
                            <BiEdit /> Edit
                        </div>
                    </div>
