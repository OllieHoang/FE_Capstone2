...
import icmember from '../assets/imgs/icmember.png';
import SCIS from '../assets/imgs/SCIS.png';
import tich from '../assets/imgs/tich.png';
import shortlink from '../assets/imgs/shortlinkpng@2x.png';
import icqrcode from '../assets/imgs/icqrcode.png';
import analasys from '../assets/imgs/analyticspng@2x.png';
import mauxanh from '../assets/imgs/mauxanh.png';
import icpject from '../assets/imgs/icpject.png';
import icpixel from '../assets/imgs/icpixeltracking.png';
import icdomain from '../assets/imgs/icdomain.png';
import ana0 from '../assets/imgs/ana0.png';
import ana5 from '../assets/imgs/ana5.png';
import group9 from '../assets/imgs/Group9.png';
            ...
            <div>
                <div className="1 lg:flex flex-col  lg:flex-row">
                    ...
                    <div className="flex flex-col justify-center pl-10 gap-y-4 lg:w-[40%] ">
                        ...
                        <p>Create your own unique and highly customizable BioLink site easily.</p>
                        <ul className="mt-2 flex flex-col gap-y-1 justify-center">
                            <li className="flex gap-x-2 items-center ">
                                <img src={tich} alt="" className="w-4 h-3 " /> Custom colors and brands
                            </li>
                            <li className="flex gap-x-2 items-center">
                ...
                <div className="2 lg:flex flex-col mt-20 lg:flex-row ">
                    <div className="flex flex-col justify-center pl-10 gap-y-4 flex-1 ">
                        ...
                        <ul className="mt-2 flex flex-col gap-y-1 justify-center">
                            <li className="flex gap-x-2 items-center ">
                                <img src={tich} alt="" className="w-4 h-3 " /> Scheduling and Expiration Limits
                            </li>
                            <li className="flex gap-x-2 items-center">
                                <img src={tich} alt="" className="w-4 h-3 " />
                ...
                <div className="3 lg:flex flex-col mt-20 lg:flex-row ">
                    ...
                    <div className="flex flex-col justify-center pl-10 gap-y-4 flex-1 ">
                        ...
                        <p>Full-featured QR code generation system with easy-to-use templates.</p>
                        <ul className="mt-2 flex flex-col gap-y-1 justify-center">
                            <li className="flex gap-x-2 items-center ">
                                <img src={tich} alt="" className="w-4 h-3 " /> Custom colors with color range
                            </li>
                            <li className="flex gap-x-2 items-center">
                                <img src={tich} alt="" className="w-4 h-3 " />
                                Custom icons
                ...
                <div className="4 lg:flex flex-col mt-20 lg:flex-row ">
                    <div className="flex flex-col justify-center pl-10 gap-y-4 flex-1 ">
                        ...
                        <p>Daily analytics, referrer, country, operating system, language and more.</p>
                    </div>
                    <div className=" flex flex-1">
                ...
                <div className="7 flex flex-col w-full h-full my-20 gap-y-3 ">
                    ...
                    <div className="flex lg:flex-row flex-col h-full w-full gap-x-8 gap-y-10 ">
                        ...
                        <div className=" flex justify-center lg:justify-end lg:items-end pb-10  ">
                            <Link to="/login" className="bg-[#E9C0E9] rounded-full px-3 py-2 ">
                ...
                <div className="8 my-20">
                    <div className="flex flex-col justify-center items-center gap-y-2">
                        <div className="text-2xl font-bold">The fast, friendly and powerful link in bio tool.</div>
                        <div className="bg-[#E9C0E9] px-3 py-2 rounded-full">Explore all plans</div>
                    </div>
                    <div className="my-10 flex flex-col lg:flex-row gap-y-10 justify-center items-center gap-x-28">
                        ...
                        <div className="flex flex-row gap-x-2">
                            <div className="px-10 py-10 rounded-3xl text-white bg-[#02ACC4]">00</div>
                            <div className="px-10 py-10 text-black rounded-full bg-[#C8D8F4]">Jan</div>
                            <div className="px-9 py-9  text-white rounded-3xl bg-[#061492]">12am</div>
                        </div>
                    </div>
