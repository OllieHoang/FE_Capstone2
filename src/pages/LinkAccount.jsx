...
const LinkAccount = () => {
    return (
        <section>
            <div className="h-screen pt-20 flex justify-around">
                <div className="w-[700px]  mt-10">
                    <label htmlFor=""> Your BioLink </label>
                    <div className="bg-red-400 px-2 py-1 rounded-2xl flex justify-center">
                        <button>Add link</button>
                    </div>
                    <div className="border border-black rounded-md mt-10 flex px-4 py-2 gap-x-4 h-[150px]">
                        ...
                        <div className="flex flex-col w-[70%] gap-x-4">
                            <div className="flex gap-x-4 relative">
                                ...
                                <label className="flex items-center absolute">
                                    <BiPencil />
                                </label>
                            </div>
                            ...
                            <div class="flex justify-between items-start pt-2 gap-2 text-concrete">
                                <div class="flex gap-2 flex-wrap">
                                    <button
                                        class="transition h-auto py-1 px-2 rounded-sm text-concrete"
                                        data-testid="LEAP_LINK_ConfigButton"
                                        data-static-el-id="LEAP_LINK_ConfigButton"
                                    >
                                    ...
                                    <button
                                        ...
                                        data-static-el-id="PRIORITY_LINK_ConfigButton"
                                    >
                                        <div class="flex items-center">
                                            <div>
                                                <svg
                                    ...
                                    <button
                                        class="transition h-auto py-1 px-2 rounded-sm text-concrete"
                                        data-testid="SCHEDULED_LINK_ConfigButton"
                                        data-static-el-id="SCHEDULED_LINK_ConfigButton"
                                    >
                                        <div class="flex items-center">
                                            <div>
                                                <svg
                                    ...
                                    <button
                                        class="transition h-auto py-1 px-2 rounded-sm text-concrete"
                                        data-testid="GATED_LINK_ConfigButton"
                                        data-static-el-id="GATED_LINK_ConfigButton"
                                    >
                                        <div class="flex items-center">
                                            <div>
                                                <svg
                                    ...
                                    <button
                                        class="transition h-auto py-1 px-2 rounded-sm text-concrete"
                                        data-testid="CLASSIC_ANALYTICS_ConfigButton"
                                        data-static-el-id="CLASSIC_ANALYTICS_ConfigButton"
                                    >
                                        <div class="flex items-center">
                                            <div>
                                                <svg
                                            ...
                                            <span class="ml-1 hidden sm:block">
                                                <div
                                                    ...
                                                    class="sc-iGctRS sc-irlOZD gOVmho jUdyne"
                                                >
                                                    <div class="sc-iGctRS eeOjBU">
                                                        <p class="sc-kUbhmq iiCMai">0 clicks</p>
                                                    </div>
                                                </div>
                                            </span>
                                        </div>
                                ...
                                <div>
                                    <button
                                        class="transition h-auto py-1 px-2 rounded-sm text-concrete"
                                        data-testid="LinkEditor_DeletePanel_Toggle_Button"
                                        data-static-el-id="LinkEditor_DeletePanel_Toggle_Button"
                                    >
                                        <div class="flex items-center">
                                            <div>
                                                <svg
                ...
                <div className="flex justify-center items-center">
                    <img src={device} alt="" className="w-[250px] h-[500px]" />
                </div>
            </div>
        </section>
    );
